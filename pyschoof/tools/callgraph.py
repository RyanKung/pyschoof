...
class CallGraph:
    ...
    def _add_function(self, file_line_name):
        ...
        if not file_line_name in self.__fln_index:
            ...
            self.__namespace_index.setdefault(
                function.namespace(), set()).add(function)
    ...
    def _remove_function(self, function):
        ...
        """
        # Remove from indexes
        fln = (function.filename(), function.line_number(),
...
class Function(CallGraphNode):
    ...
    def primitive_callcount(self):
        ...
        @return    How often the function was called except for recursive
                   loops.
        """
        incoming_callcounts = [c.primitive_callcount()
                               for c in self.incoming_calls()]
    ...
    def total_callcount(self):
        ...
        """
        incoming_callcounts = [c.total_callcount()
                               for c in self.incoming_calls()]
